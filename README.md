...
## Installation 
[![](https://img.shields.io/badge/source%20package-NOREVA--0.1.0.tar.gz-blue.svg)](https://github.com/idrblab/NOREVA/archive/0.1.0.tar.gz)

```R
Method 1. Download the source package of NOREVA-0.1.0.tar.gz and install it
install.packages("NOREVA_0.1.0.tar.gz", repos = NULL, type = "source", INSTALL_opts = "--no-multiarch")
...
install.packages(c('rJava', 'DiffCorr', 'MetNorm', 'ggsci', 'multiROC', 'dummies', 'ggfortify', 'ggpubr', 'sampling', 'VennDiagram', 'RcmdrMisc', 'reshape2', 'futile.logger'))
...
<font size=3>2. This function enables the performance assessment of time-course metabolomic study with dataset with QCSs based on 4 distinct criteria. It could automatically assess the performance of all processing workflows from different criteria.</font>
...
<font size=3>3. This function enables the performance assessment of time-course metabolomic study with dataset with ISs based on 4 distinct criteria. It could automatically assess the performance of all processing workflows from different criteria.</font>
...
<font size=3>4. This function enables the performance assessment of time-course metabolomic study with dataset without QCSs and ISs based on 4 distinct criteria. It could automatically assess the performance of all processing workflows from different criteria.</font>
...
<font size=3>5. This function enables the performance assessment of multi-class (N>1) metabolomic study with dataset with QCSs based on 4 distinct criteria. It could automatically assess the performance of all processing workflows from different criteria.</font>
...
<font size=3>6. This function enables the performance assessment of multi-class (N>1) metabolomic study with dataset with ISs based on 4 distinct criteria. It could automatically assess the performance of all processing workflows from different criteria.</font>
...
<font size=3>7. This function enables the performance assessment of multi-class (N>1) metabolomic study with dataset without QCSs and ISs based on 4 distinct criteria. It could automatically assess the performance of all processing workflows from different criteria.</font>
...
<font size=3>8. This function enables the performance assessment of time-course metabolomic study with dataset with QCSs based on 5 distinct criteria including the performance of processing workflows could be assessed using criteria (e).</font>
...
<font size=3>9. This function enables the performance assessment of time-course metabolomic study with dataset with ISs based on 5 distinct criteria including the performance of processing workflows could be assessed using criteria (e).</font>
...
<font size=3>10. This function enables the performance assessment of time-course metabolomic study with dataset without QCSs and ISs based on 5 distinct criteria including the performance of processing workflows could be assessed using criteria (e).</font>
...
<font size=3>11. This function enables the performance assessment of multi-class (N>1) metabolomic study with dataset with QCSs based on 5 distinct criteria including the performance of processing workflows could be assessed using criteria (e).</font>
...
<font size=3>12. This function enables the performance assessment of multi-class (N>1) metabolomic study with dataset with ISs based on 5 distinct criteria including the performance of processing workflows could be assessed using criteria (e).</font>
...
<font size=3>13. This function enables the performance assessment of multi-class (N>1) metabolomic study with dataset without QCSs and ISs based on 5 distinct criteria including the performance of processing workflows could be assessed using criteria (e).</font>
