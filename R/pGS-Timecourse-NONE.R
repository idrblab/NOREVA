#' @title Time-course Metabolomic Study with dataset without QCSs & ISs and the corresponding data of golden standards for performance evaluation using Criterion e.
#' @description this function enables the performance assessment of metabolomic data processing
#' for time-course dataset (without quality control sample and without internal standard)
...
#' @import DiffCorr affy vsn DT iterators doSNOW
...
#' @usage nortimecoursenoallgs(fileName, GS, SAalpha="Y", SAbeta="Y", SAgamma="Y")
#' @export nortimecoursenoallgs
#' @examples
#' library(NOREVA)
#' \donttest{timec_non_data <- PrepareInuputFiles(dataformat = 1,
#' rawdata = "Timecourse_without_QCSIS.csv")}
#' \donttest{nortimecoursenoallgs(fileName = timec_non_data,
#' GS = "Timecourse_without_QCSIS_GoldenStandard.csv", SAalpha="Y", SAbeta="Y", SAgamma="Y")}

nortimecoursenoallgs <- function(fileName, GS, SAalpha="Y", SAbeta="Y", SAgamma="Y"){
