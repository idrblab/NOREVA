#' @title Process the dataset of multi-class (N>1) metabolomic study.
#' @description based on a particular processing workflow (especially the one identified as well-performing
#' for the studied metabolomic multi-class dataset),
#' this function outputs the resulting levels of all metabolites among all samples
#' after the data processing based on that workflow. Quality control sample (QCS) and internal standard (IS)
#' are considered in this function.
#' @param datatype Allows the users to specify the data type of their input peak table (default = null).
#' “1” denotes the multi-class metabolomic dataset without QCSs and without ISs.
#' “2” denotes the multi-class metabolomic dataset with QCSs but without ISs.
#' “3” denotes the multi-class metabolomic dataset with ISs but without QCSs.
#' @param fileName Allows the users to indicate the NAME of peak table resulted from PrepareInuputFiles() (default = null)
...
#' For example, the value of argument IS that is set to “2,6,8,n” indicates
#' that the metabolites in the 3rd, 7th, 9th, and (n+1)th columns of your
#' input peak table should be considered to be the IS metabolites.
...
normulticlassmatrix <- function(datatype, fileName, IS, impt=NULL, qcsn=NULL, trsf=NULL, nmal=NULL, nmal2=NULL, nmals=NULL){
